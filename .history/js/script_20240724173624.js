...
function filtrarPorCategoria(categoria) {
    const videos = document.querySelectorAll(".videos__item");
    videos.forEach((video) => {
        const categoriaDoVideo = video.querySelector(".titulo-canal").textContent.toLowerCase();
        video.style.display = categoria ? categoriaDoVideo.includes(categoria) ? "block" : "none": "block";
    });
}
