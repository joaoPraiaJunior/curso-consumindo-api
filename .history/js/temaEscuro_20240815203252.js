function temaEscuro() {
    ...
    function modoEscuro() {
        if(botaoModoEscuro.checked) {
            ...
            botaoModoEscuro.setAttribute('aria-label', 'Botao de modo escuro da página');
            ...
            botaoModoEscuro.setAttribute('aria-label', 'Botão de modo claro da página');
    ...
    function verificarModoEscuro() {
        ...
        if(modoEscuro) {
            ...
            botaoModoEscuro.setAttribute('aria-checked', 'true');
            botaoModoEscuro.setAttribute('aria-label', 'Botão modo escuro da página');
        }
    }
